...
- Extreme speed improvements: literally faster than the C version (benchmark source included)
  ...
  - Bloom filter used to avoid fruitless lookups
...
- Many bug fixes
  ...
  - solved iteration bugs and memory leaks
  - dealt with various thread safety bugs
...
- New / changed API methods
  ...
  - Word.getSenses() → Word.getSynsets() and added List<WordSense> Word.getWordSenses()
