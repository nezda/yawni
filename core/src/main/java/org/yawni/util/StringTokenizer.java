...
public final class StringTokenizer extends AbstractCharSequenceTokenizer implements Iterator<String> {
  /**
   * Constructs a new <code>StringTokenizer</code> for {@code string} using whitespace as
   * the delimiter.
   *
  ...
  /**
   * Constructs a new <code>StringTokenizer</code> for {@code string} using the specified
   ...
   * @throws NoSuchElementException if no tokens remain
   */
  public String nextToken(final String delims) {
