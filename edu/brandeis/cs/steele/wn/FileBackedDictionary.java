...
public class FileBackedDictionary implements DictionaryDatabase {
	...
	protected final int DEFAULT_CACHE_CAPACITY = 100000;
	...
	public IndexWord getIndexWordAt(POS pos, long offset) {
	...
	public Enumeration searchIndexBeginning(final POS pos, final String substring) {
		...
		return new LookaheadEnumeration(new Enumeration() {
			...
			public Object nextElement() {
				...
				try {
					...
					long offset = db.getMatchingBeginningLinePointer(filename, nextOffset, substring);
